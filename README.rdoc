...
values_for automatically runs validates_inclusion_of on this field.  To override the validation, you can pass
:allow_nil=>true.  All the validates_inclusion_of options are supported.
